...
use common\models\model\RoomIp;
...
class RoomIpController extends ApiActiveController
{
    ...
    public $table_name = 'room_ip';
    public $controller_name = 'RoomIp';
    ...
    public function actionIndex($lang)
    {
        ...
        $query = $model->find()->where(['is_deleted' => 0])
            ->andFilterWhere(['like', 'ip', Yii::$app->request->get('query')]);
    ...
    public function actionCreate($lang)
    {
        ...
        $result = RoomIp::createItem($model, $post);
        if (!is_array($result)) {
    ...
    public function actionExcelImport($lang) {
        $post = Yii::$app->request->post();
        $result = RoomIp::createExcelImport($post);
        if (!is_array($result)) {
